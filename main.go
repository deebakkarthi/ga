...
const goalString string = "to be or not to be"
...
func reproduction(population *[]DNA, matingPool *[]DNA, crossover func(a, b DNA) DNA,
...
func main() {
	...
	for string(population[len(population)-1].genes[:]) != goalString {
		...
		reproduction(&population, &matingPool, crossover, mutate)
